...
| 2026-07-12 | TextAreaModal multilinea en ctx task, session contexts paralelos con timestamp + purge 4h + aviso tab AHORA, título de terminal por ticket (ANSI escape), campo ticket ID en flujo task con precarga en ticket_activo.json — push en personal y main | Empaquetar .exe nuevo, verificar Option B en compilado |
